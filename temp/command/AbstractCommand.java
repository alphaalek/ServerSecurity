...
public abstract class AbstractCommand implements CommandExecutor {
    ...
    public void sendHelpMessage(AbstractCommand abstractCommand, CommandSender sender) {
        sender.sendMessage("Sender kommandoer du kan bruge...");
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (response == CommandResponse.Response.NO_PERMISSION) {
            sender.sendMessage("Du har ikke adgang til denne kommando.");
            return true;
        }
    ...
    public abstract ArrayList<SubCommand> registerSubCommands();
