...
public class CommandInjector extends AbstractListener {
    ...
    private List<String> labelsWrapping = Arrays.asList("ban", "banip", "ban-ip", "op", "deop", "unban", "unbanip", "pardon", "pardonip", "pardon-ip", "stop", "kick", "kickall", "whitelist", "kill", "gamemode");
