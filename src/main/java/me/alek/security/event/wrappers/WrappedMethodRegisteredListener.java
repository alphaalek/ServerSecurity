...
public class WrappedMethodRegisteredListener extends RegisteredListener {
    ...
    public WrappedMethodRegisteredListener(Listener listener, EventExecutor eventExecutor, EventPriority priority, Plugin plugin, Method method, boolean isIgnoringCancelled) throws NoSuchMethodException {
