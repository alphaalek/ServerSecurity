...
public class InfoCommand implements SubCommand {
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        player.sendMessage("§4Malware: §7Hostflow, SkyRage, Qlutch, Ectasy, OpenEctasy, ThiccIndustries, Bukloit, OpenBukloit");
        player.sendMessage("§cHøj risiko: §7Obfuscated, Force OP, Bytecode Manipulation");
        player.sendMessage("§eModerat risiko: §7Dispatch Command, Discord Webhook, L10 Class, System Access, User-Agent Request, Embedded JAR, Websocket");
        player.sendMessage("§aLav risiko: §7Cipher Encryption, Base64, ClassLoader, Hidden File, IP Grabber, Load Plugins, OpenConnection, System Property, AsyncPlayerChatEvent");
